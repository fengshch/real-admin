 ...
 * @since 2024-10-24
 */
public class PasswordResetTableDef extends TableDef {
     ...
     * 
     */
    public static final PasswordResetTableDef PASSWORD_RESET_PO = new PasswordResetTableDef();
    ...
    public PasswordResetTableDef() {
        super("", "password_reset");
    }

    private PasswordResetTableDef(String schema, String name, String alisa) {
        super(schema, name, alisa);
    }

    public PasswordResetTableDef as(String alias) {
        String key = getNameWithSchema() + "." + alias;
        return getCache(key, k -> new PasswordResetTableDef("", "password_reset", alias));
    }
